        ...
        <Container>
            <FormContainer>
                <Form onSubmit={handleSubmit}>
                    ...
                    <InputLabel>
                        <Label>Precio:</Label>
                        <Input type="text" name="valor" value={data.valor} onChange={handleChange} placeholder="Precio USD"/>
                    </InputLabel>
                    <InputLabel>
                        <Label>Estado:</Label>
                    ...
                    <InputLabel>
                        ...
                        <Input type="text" name="comprador" value={data.comprador} onChange={handleChange} placeholder="Comprador"/>
                    </InputLabel>
